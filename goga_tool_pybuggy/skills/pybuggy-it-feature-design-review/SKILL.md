---
name: goga-tool-pybuggy-it-feature-design-review
...
---
# Pybuggy IT Feature Design Review
...
2. `goga-tool-pybuggy-it-usage`, `goga-tool-pybuggy-it-cookbook` — pybuggy runtime/DSL тест-cells.
...
5. **Ограничения:** без Entities, без `Imports`, без новых `__init__.py`. Нарушение = **High**.
