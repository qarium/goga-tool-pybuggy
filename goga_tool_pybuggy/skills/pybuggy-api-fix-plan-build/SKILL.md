...
- Проверка: rerun затронутых тестов — зелёный.
...
- Действия: допиши в `docs/bugs/<feature>.md` запись `BUG-<feature>-<N>` (сквозная нумерация): суть, эндпоинт, severity,
  тест, ожидание vs факт (из досье анализа), шаги воспроизведения, traceback из `docs/fix/<feature>-log.txt`.
