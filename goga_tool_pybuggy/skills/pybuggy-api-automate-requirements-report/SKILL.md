...
4. Перенести в §8 реестр usages из секции «Usages проекта» [DISCOVERY_REPORT] (ключ | путь | роль |
   назначение — справочник доступного, без выбора инструментов).
5. Перенести в §9 статус покрытия из секции «Существующее покрытие» [DISCOVERY_REPORT] (какие эндпоинты уже
