...
по Routine — один Routine может покрывать один или несколько связанных кейсов (в т.ч. параметризованно); грани́цы Routine — проектное решение. Ты **предлагаешь**
...
3. Зафиксировать маппинг: кейс (id, тип) → Routine → cell (один Routine может покрывать несколько кейсов).
...
[Таблица: cell | Routine (test_<name>) | кейсы (id, тип Flow/Positive/Negative — один или несколько на Routine) | сигнатура]
