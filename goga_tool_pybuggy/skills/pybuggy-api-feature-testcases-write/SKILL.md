---
name: goga-tool-pybuggy-api-feature-testcases-write
...
1. **Предусловия** — состояние системы и данные ДО теста: env/version, дата-сетап (сущности, роли,
   ...
   пользовательской библиотекой (из §10 требований) — указать в Предусловиях «данные подготавливаются
   библиотекой `<ключ>`» **без** деталей реализации (без импортов/вызовов).
