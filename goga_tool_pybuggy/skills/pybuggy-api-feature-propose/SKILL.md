---
name: goga-tool-pybuggy-api-feature-propose
...
Собрать артефакт «Детальные требования для фичи»: что именно тестируем, какие эндпоинты задействованы, успешные и
ошибочные сценарии, какие данные и предусловия, какие ответы ожидаются — и сохранить его в
`docs/pybuggy/feature-requirements.md`.
...
- Invoke: `goga-tool-pybuggy-api-feature-propose-intake` с `$ARGUMENTS`
...
- Invoke: `goga-tool-pybuggy-api-feature-propose-discovery`
- Reads: [INTAKE_REPORT]
...
- Invoke: `goga-tool-pybuggy-api-feature-propose-elaborate`
- Reads: [INTAKE_REPORT], [DISCOVERY_REPORT]
- Output: [ELABORATION_REPORT]
- STOP if: критическая неоднозначность предусловий, блокирующая построение сценариев

### Step 4. Report

- Invoke: `goga-tool-pybuggy-api-feature-propose-report`
