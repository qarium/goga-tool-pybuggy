---
name: goga-tool-pybuggy-it-feature-design
...
---
# Pybuggy IT Feature Design (dispatch)
...
- **Runtime/фикстуры:** pybuggy `Api`, `Endpoint`, `ResponseWrapper`, assert-слой из
  `.goga/usages/cooks/pybuggy/`. Грузи через скиллы `goga-tool-pybuggy-it-usage` и
...
2. Загрузи контекст тестов через **Skill tool**: `goga-tool-pybuggy-it-usage` и `goga-tool-pybuggy-it-cookbook`.
...
- грузить pybuggy runtime-референс (`goga-tool-pybuggy-it-usage`, `goga-tool-pybuggy-it-cookbook`)
