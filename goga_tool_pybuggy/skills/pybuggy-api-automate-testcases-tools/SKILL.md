...
утилиты), **сопоставляешь** их с реестром usages из §10 требований и **согласуешь** решение с
...
2. `docs/pybuggy/feature-requirements.md` §10 «Доступные usages проекта» — реестр существующих usages
   (ключ | путь | роль | назначение).
3. При §10 «usages отсутствуют» — выполнить скан `.goga/usages/` самостоятельно (как в
...
Для каждой потребности найти покрывающий usage в реестре §10 (по роли «данные-моки-утилиты» и
...
[Таблица: потребность | usage-ключ (из §10) | статус (покрыта / нет)]
