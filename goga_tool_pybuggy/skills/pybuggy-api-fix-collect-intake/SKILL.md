...
3. Выполни: `pytest <пути> -q 2>&1 | tee docs/fix/<topic>-log.txt` (создай `docs/fix/`, если её нет; `<topic>` — из `$ARGUMENTS`, не определён — спроси пользователя; повторный прогон — перезапись).
...
## Прогон
[Команда: ... | Лог: docs/fix/<topic>-log.txt | Код выхода: ... | Итог: passed/failed/errors/skipped.
