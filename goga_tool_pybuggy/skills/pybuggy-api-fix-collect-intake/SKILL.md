...
description: Определение источника данных о падениях и локальный запуск тестов с сохранением вывода в /tmp
---
...
3. Выполни: `pytest <пути> -q 2>&1 | tee /tmp/pybuggy-fix-<метка_времени>.log`.
...
## Прогон
[Команда: ... | Лог: /tmp/... | Код выхода: ... | Итог: passed/failed/errors/skipped.
