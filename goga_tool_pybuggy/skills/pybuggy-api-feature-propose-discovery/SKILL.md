...
### Step 4. Обнаружить существующее покрытие тестов
...
### Step 5. Подтвердить отбор у пользователя
...
### Step 7. Сгенерировать артефакты (generate)
...
### Step 8. Сформировать [DISCOVERY_REPORT]
