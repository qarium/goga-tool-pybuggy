...
3. **Topic description and goal (§1)** — the user's verbatim description of the topic and the
...
[Table: endpoint-id | spec | method | path | role in the topic | path to api.py (fixture name) | schemas | tests/]

## Declared behavior

- Topic description (verbatim, §1): [...]
- Main behavior: [...]
